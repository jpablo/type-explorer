...
import org.jpablo.typeexplorer.ui.app.components.tabs.inheritanceTab.InheritanceTabZ
import org.jpablo.typeexplorer.ui.app.components.tabs.semanticDBTab.SemanticDBTabZ
...
def TabsAreaZ =
  for
    inheritanceTabContent <- InheritanceTabZ
    semanticDBTabContent <- SemanticDBTabZ
  yield
